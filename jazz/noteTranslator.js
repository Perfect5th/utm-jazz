...
export default class NoteTranslator {
    constructor(tape, octave = 0) {
        this.tape = tape;
        this.freqChart = [0, 65.40639, 73.41619, 82.40689, 87.30706, 97.99886, 110.0000, 123.4708, 130.8128, 
                             65.40639, 73.41619, 82.40689, 87.30706, 97.99886, 110.0000, 123.4708, 130.8128];
        this.notes = [];

        this.freqChart = this.freqChart.map(f => f * Math.pow(2, octave));
    }
